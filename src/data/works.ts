...
export const works: Work[] = [
  {
    ...
    copy: {
      vi: {
        ...
        summary:
          'Web app gia phả cho dòng họ Nguyễn Phước Tộc: cây gia phả tương tác 8 đời, tra cứu thành viên và mộ phần, xuất PDF, xem tốt trên điện thoại.',
        scope: [
          'Thiết kế và phát triển toàn bộ hệ thống',
          'Cây gia phả tương tác 8 đời',
          'Tìm kiếm thành viên, thống kê, xuất PDF',
          'Tra cứu mộ phần',
          'Đăng ký tài khoản thành viên',
          'Mục tin tức và album dòng họ',
          'Đếm ngược ngày giỗ theo lịch âm',
          'Luồng tra cứu tối ưu riêng cho điện thoại',
        ],
      },
      en: {
        ...
        summary:
          'A genealogy web app for the Nguyen Phuoc clan: an interactive 8-generation family tree, member and gravesite lookup, PDF export, built to read well on phones.',
        scope: [
          'Full system design and development',
          'Interactive 8-generation family tree',
          'Member search, statistics, PDF export',
          'Gravesite lookup',
          'Member account registration',
          'Clan news and photo albums',
          'Lunar-calendar memorial day countdown',
          'Lookup flow optimised for mobile',
        ],
      },
    },
  },
