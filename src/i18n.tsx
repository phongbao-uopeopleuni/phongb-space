...
const en = {
  ...
  contact: {
    ...
    errPhone: 'That phone number looks incomplete — please enter at least 8 digits.',
    errEmail: 'That email address is not valid.',
    errNetwork: 'No connection. Check the network and try again, or reach me on Zalo.',
    errDomain: 'This form only accepts submissions from the official site. Please use Zalo instead.',
    errQuota: 'The form has hit its monthly submission limit. Please use Zalo or call instead.',
...
const vi: typeof en = {
  ...
  contact: {
    ...
    errPhone: 'Số điện thoại chưa đủ — vui lòng nhập ít nhất 8 số.',
    errEmail: 'Email chưa đúng định dạng.',
    errNetwork: 'Không kết nối được. Kiểm tra mạng rồi thử lại, hoặc liên hệ qua Zalo.',
    errDomain: 'Form chỉ nhận gửi từ trang chính thức. Vui lòng liên hệ qua Zalo.',
    errQuota: 'Form đã đạt giới hạn lượt gửi trong tháng. Vui lòng liên hệ qua Zalo hoặc gọi điện.',
